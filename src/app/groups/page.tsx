          ...
          <div className="mx-auto grid max-w-7xl gap-10 px-4 sm:px-6 lg:grid-cols-2 lg:px-8">
            ...
            <div className="rounded-lg border border-stone-200 bg-stone-50 p-6 sm:p-8">
              ...
              <p className="mt-3 leading-7 text-stone-700">
                Eight bedrooms across floors two through four: two kings and six queens,
                with five full bathrooms and a powder room keeping the mornings civil. Bedrooms sit on the upper floors of
