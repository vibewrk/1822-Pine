  ...
  return (
    <div className="flex flex-col bg-[#fbfaf7] text-stone-950">
      ...
      <StayCta
        ...
        body="All eight works are a two-block walk from The Rittenhouse Residence. Send the kids to find Billy and the frog; the house's own 8 bedrooms and three shared living rooms are waiting when the hunt is over."
      />
